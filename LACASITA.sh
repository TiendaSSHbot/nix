...
####################################
# BY: CAT                          #
# Modificado: 22/marzo 2023        #
# Creado para Nixon                #
# DISPONIBLE: UBUNTU/14/23         #
#                       LINUX..... #
####################################
...
echo -e " \033[1;33m\033[45m  =====>>►►  SCRIPT OFFICIAL TIENDASSH  ◄◄<<=====  \033[0m"
...
msg -ama "     [ SCRIPT \033[1;97m tiendasshgen_bot\033[1;33m ]"
...
install_fim() {
    ...
    echo 'figlet ":TiendaSSH:"|lolcat' >>.bashrc
    ...
    echo -e "  \033[1;41m               sudo nixon             \033[0;37m" && msg -bar2
...
if [[ -e $HOME/lista-arq ]] && [[ ! $(cat $HOME/lista-arq | grep "Code de KEY Invalido!") ]]; then
    ...
    msg -verd "    $(source trans -b es:${id} "Ficheros Copiados" | sed -e 's/[^a-z -]//ig'): \e[97m[\e[93m@tiendasshgen_bot\e[97m]"
